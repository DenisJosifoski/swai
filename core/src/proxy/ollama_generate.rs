...
use super::ollama_streaming::{build_ollama_generate_chunks, OllamaStreamingBody};
...
pub fn ollama_generate_to_openai(req: &OllamaGenerateRequest) -> serde_json::Value {
